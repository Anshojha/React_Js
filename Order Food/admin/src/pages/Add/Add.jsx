...
const Add = () => {
    ...
    return (
        <div className='add'>
            <form action="" className="flex-col" onSubmit={onSubmitHndler}>
                ...
                <div className="add-product-description flex-col">
                    ...
                    <textarea onChange={onChangehandler} value={data.description} name="description" rows="6" placeholder='Write products details here' required></textarea>
                </div>
