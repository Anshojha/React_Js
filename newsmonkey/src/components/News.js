...
useEffect(async ()=>{
  ...
  handleNextBtn = async () => {
    console.log("Next");
    if(!(this.state.page +1 > Math.ceil(this.state.totalResults/this.props.pageSize))){  let url = `https://newsapi.org/v2/everything?q=tesla&from=2023-02-22&sortBy=publishedAt&apiKey=ee6d572b3b8f4078ac9bb72702c39ff7`;
